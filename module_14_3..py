...
api = '8088985825:AAHDzALrd9VSiCuOf11wsssi10O3WmZnlZg'
bot = Bot(token=api)
...
async def get_buying_list(message):
    for i in range(4):
        with open(f'Product_{i + 1}.jpg', 'rb') as img:
            await message.answer_photo(img, f'Название: Product{i + 1} | Описание: описание {i + 1} '
                                            f'| Цена: {(i + 1) * 100}')
